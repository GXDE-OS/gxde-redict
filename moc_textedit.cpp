...
QT_MOC_LITERAL(3, 18, 8) // "focusOut"

    },
    "TextEdit\0focusIn\0\0focusOut"
};
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextEdit::focusIn)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TextEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextEdit::focusOut)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TextEdit::focusIn()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TextEdit::focusOut()
{

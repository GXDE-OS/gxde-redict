...
QT_MOC_LITERAL(5, 30, 13) // "buttonRelease"

    },
    "EventMonitor\0buttonPress\0\0x\0y\0"
    "buttonRelease"
};
...
void EventMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        EventMonitor *_t = static_cast<EventMonitor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->buttonPress((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        case 1: _t->buttonRelease((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (EventMonitor::*)(const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventMonitor::buttonPress)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (EventMonitor::*)(const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventMonitor::buttonRelease)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject EventMonitor::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_EventMonitor.data,
      qt_meta_data_EventMonitor,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void EventMonitor::buttonPress(const int _t1, const int _t2)
{
...
// SIGNAL 1
void EventMonitor::buttonRelease(const int _t1, const int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
